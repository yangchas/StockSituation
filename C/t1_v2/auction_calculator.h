...
private:
    bool capture_anchor_prices(AuctionState& auction, const RawTick& tick, MarketPhase phase) const;
    ...
    int effective_matching_price_milli(const RawTick& tick, MarketPhase phase) const;
